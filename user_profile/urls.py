...
from.views import (
    UserProfileView, OwnerProfilePhotoUpdateView, stream_profile_pic, OwnerProfilePhotoDeleteView, OwnerAboutView, CreateChatView, ListChatView, CreateFavriouteView,
    DeleteFavriouteView, UserUpdateView, PasswordUpdateView
)
...
urlpatterns = [
    ...
    path('chat/<int:pk>', CreateChatView.as_view(), name='chat'),
    path('chat_list/', ListChatView.as_view(), name='chat_list'),
